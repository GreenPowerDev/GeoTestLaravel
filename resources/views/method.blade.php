...
@section('main-content')
    ...
    <section class="method_detail">
        ...
        <div class="method_context"><ul>
            <li class="method_sentence"><img src="{{asset('/img/top/content/top_method-culture.jpg')}}" alt="">歴史・文化を知ることは今を知ることにつながります。誰しも歴史上の人物の一人くらいは知っているのではないでしょうか。それでいて知ってそうで知らない歴史もたくさんあるかもしれません。ふるさとやお気に入りの土地の良さを知り、親しみやすく奥深い歴史・文化を楽しみましょう。</li>
            <li class="method_sentence">全国47都道府県に問題が分かれているので受験する都道府県を自由に選ぶことができます。ふるさとの県を選んでも良いですし、観光で気に入った県を選ぶのも良いでしょう。</li>
            <li class="method_sentence">各都道府県ごとにブロンズ(3級)、シルバー(2級)、ゴールド(準1級)、プラチナ(1級)と自分の目標に合わせて受験ができます。自分のペースでステップアップしていけるようになっています。合格するとプラチナ・マイスターやゴールド・マイスターなどの資格(称号)が付与されます。そして、複数のプラチナ・マイスターを取得し規定をクリアするとダイヤモンド・マイスターの資格(称号)が付与されます。<img src="{{asset('/img/top/content/top_method-other.jpg')}}" alt=""></li>
            ...
            <li class="method_sentence"><img src="{{asset('/img/top/content/top_method-school.jpg')}}" alt="">学校での社会科や日本史はもちろんのこと、地理あるいは古文、美術、地学など多くの科目の学力の向上に寄与するかもしれません。また生涯学習の道しるべとしてライフワークとして取り組むこともできます。</li></ul>
        </div>
        ...
        <div class="method_context"><ul>
            ...
            <li class="method_sentence"><img src="{{asset('/img/top/content/top_method-clock.png')}}" >受験当日はまず受験開始時刻より前にログインを済ませて下さい。そしてインターネットの接続が安定している部屋で指定の時刻に受験して下さい。静かな部屋での受験をおすすめします。</li>
